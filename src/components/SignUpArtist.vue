  ...
  <div class="main min-h-screen flex justify-center items-center bg-black ">
    <div class="container max-w-7xl w-full bg-white rounded-lg shadow-lg flex">
      <div class="w-2/3">
        <img src="/src/assets/pink.jpg" alt="Billie" class="w-full h-full object-cover"/>
      </div>
      <div class="w-1/2 p-8">
     ...
     <div class="form-group">
            ...
            <div class="space-y-6">
              ...
              <div class="flex justify-center mt-4">
                ...
                <button @click="navigateToLogin" class="bg-white border-blood border-2 hover:bg-blood hover:text-white  text-black font-bold py-2 px-4 rounded-full mb">Login</button>
              </div>
...
export default {
  ...
  setup() {
    ...
    const formFields = [
      ...
      { label: 'Bio', id: 'bio', type: 'text', model: 'bio', required: false }
