      ...
      <div class="p-6 pt-16 bg-black max-h-full flex-grow relative z-1">
        <div class="flex flex-row">
          <div class="relative group">
            <img :src="getProfileImageUrl(user?.image)" alt="User Image" 
...
import { updateUser, fetchUser, followUser,updateUserProfileImage, unfollowUser, isFollowing as fetchIsFollowing } from '../../api/User';
