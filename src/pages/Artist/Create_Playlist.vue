      ...
      <template #Main>
        ...
        <main class="flex-grow bg-black p-8 flex flex-col space-y-4">
              ...
              <table class="min-w-full bg-black text-white">
                ...
                <tbody>
                  <tr v-for="track in playlist" :key="track.id" class="text-center">
                    ...
                    <td class="py-2 px-4 border-b border-red-700 text-center">{{ formatDate(track.releaseDate) }}</td>
                    <td class="py-2 px-4 border-b border-red-700 text-center">{{ track.duration }}</td>
                    <td class="py-2 px-4 border-b border-red-700 text-center">{{ track.singer }}</td>
          ...
          <div>
            ...
            <div class="p-1 mb-4">
              <input type="text" v-model="searchTerm" placeholder="Search..." class="w-100 p-2 border border-gray-300 rounded-md bg-black text-white">
            </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        playlist: [],
        tracks: [
          { id: 1, title: 'Song 1', releaseDate: '2021-01-01', duration: '3:45', singer: 'Singer 1' },
          { id: 2, title: 'Song 2', releaseDate: '2021-02-01', duration: '4:15', singer: 'Singer 2' },
          { id: 3, title: 'Song 3', releaseDate: '2021-03-01', duration: '2:55', singer: 'Singer 3' },
          { id: 4, title: 'Song 4', releaseDate: '2021-04-01', duration: '3:35', singer: 'Singer 4' },
          { id: 5, title: 'Song 5', releaseDate: '2021-05-01', duration: '3:05', singer: 'Singer 5' },
          { id: 6, title: 'Song 6', releaseDate: '2021-06-01', duration: '4:05', singer: 'Singer 6' },
        ],
      };
    },
    computed: {
      filteredTracks() {
        ...
        return this.tracks.filter(track => track.title.match(regex));
      }
    },
    methods: {
      toggleEditForm() {
