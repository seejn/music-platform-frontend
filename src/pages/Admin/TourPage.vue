<template>
  ...
  <div class="rounded-lg p-6">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div v-for="tour in tours" :key="tour.id" class="p-4 rounded-lg shadow-lg border-2 border-red-800 bg-gray-800 hover:ring-2 hover:ring-red-800">
        <div class="flex">
          <div class="mr-4 flex-shrink-0">
            <img :src="tour.artist ? imageUrl(tour.artist) : ''" alt="Artist Image" class=" w-48 h-48 rounded-lg border-2 border-white">
          </div>
